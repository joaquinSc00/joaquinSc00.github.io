...
- El parser intenta que `Tarea` quede como `TP1`, `TP2`, `Parcial`, `Final`, etc., y no como el texto completo de la materia.
- Si Google Assistant agrega una descripcion y la deja en el titulo despues de un separador como ` - ` o `:`, el script intenta mover esa parte al campo `Comentarios`.
